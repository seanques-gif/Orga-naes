  ...
  importInput.addEventListener('change', () => {
    ...
    reader.onload = (e) => {
      ...
      try {
        const { data, importedCategories, importedCollapsed, importedTrash, importedToday, importedWeekly, importedReminders, importedEmojis, importedNotes, importedNoteTombstones } = extractImportData(parsed);
