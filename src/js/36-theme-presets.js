  ...
  const THEME_PRESETS = {
    ...
    daylight: { '--bg':'#eef1f5','--card':'#ffffff','--card-hover':'#f3f6f9','--card-border':'#d3dbe4','--sub-bg':'#f6f8fa','--sub-border':'#dfe6ee','--accent':'#0a7ea4','--accent-contrast':'#ffffff','--text':'#12202c','--text-dim':'#5a6b7b','--header-bg':'#ffffff','--toast-bg':'#12202c','--hover-border':'#a9b8c7','--planned':'#4a5d8a','--ongoing':'#9a5d00','--completed':'#0f7a4a','--waiting':'#6a4fd0','--danger':'#c0392b' }
  };
